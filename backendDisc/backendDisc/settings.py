"""
Django settings for backendDisc project.
...
SECRET_KEY = 'django-insecure-so$*eh@pq9=)t-unmw=a4xr78k!kp0#9w-x3hwigq=(i^t%+^n'
...
WSGI_APPLICATION = 'backendDisc.wsgi.application'
